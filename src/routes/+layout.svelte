...
<main class="min-h-screen flex flex-col">
	...
	<footer class="footer p-8 bg-base-300 text-base-content flex mb-16">
		<!-- <nav>
		...
		<nav>
			...
			<div class="grid grid-flow-col gap-4">
				...
				<a target="_blank" href="https://www.instagram.com/washywashyy/"
					><svg
						width="24"
						class="fill-current"
						height="24"
				...
				<a target="_blank" href="https://www.youtube.com/channel/UCh1ymSxDli459OgKVtuQItg"
					><svg
						xmlns="http://www.w3.org/2000/svg"
						width="24"
						height="24"
	...
	<div class="btm-nav btm-nav-md">
		...
		<button
			class:active={$page.url.pathname.startsWith('/bookings') ||
				$page.url.pathname.startsWith('/ordersDetails')}
		>
